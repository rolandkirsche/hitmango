...
export const levels: Level[] = [
  ...
  // ── Mixed levels with cans (16–20) ─────────────────────────────────────────
  {
    id: 16,
    name: 'The Embassy',
    // 3×3 grid — sniper holds top-left, sentry at h, knife man at i, 1 can
    // BFS solution: s → wait → d → e → f → ex  (5 moves)
    nodes: [
      { id: 's',  x:  80, y: 300 },
      { id: 'a',  x: 210, y: 175 },
      { id: 'b',  x: 340, y: 175 },
  ...
  },
  {
    id: 17,
    name: 'The Courtyard',
    // Open cross — 2 knife men + 1 patrol, 1 can
    // BFS solution: s → wait → a → d(kill km1) → e(kill g1) → g → ex  (6 moves)
    nodes: [
      { id: 's',  x:  80, y: 300 },
      { id: 'a',  x: 210, y: 300 },
      { id: 'b',  x: 340, y: 175 },
    ...
    edges: [
      { from: 's', to: 'a'  },
      { from: 'a', to: 'b'  }, { from: 'b', to: 'c'  },
      { from: 'a', to: 'd'  }, { from: 'b', to: 'e'  }, { from: 'c', to: 'e' },
      { from: 'd', to: 'e'  }, { from: 'a', to: 'f'  }, { from: 'd', to: 'f' },
      { from: 'e', to: 'g'  }, { from: 'g', to: 'ex' },
    ],
    playerStart: 's',
    exit: 'ex',
    cans: 1,
    enemies: [
      { id: 'g1',  type: 'patrol', path: ['b', 'e'],              startIndex: 0 },
      { id: 'km1', type: 'knife',  node: 'd', path: ['a','e','g'], startIndex: 0 },
      { id: 'km2', type: 'knife',  node: 'f', path: ['c','e','g'], startIndex: 2 },
    ],
  },
  {
    id: 18,
    name: 'The Watchtower',
    // Two-column — sniper at c (dead-end), patrol + sentry + knife block middle
    // Solution: wait → s→a → a→b(kill g1) → wait → b→e → e→f(kill km1) → f→ex  (7 moves)
    nodes: [
      { id: 's',  x:  80, y: 300 },
      { id: 'a',  x: 210, y: 175 },
      { id: 'b',  x: 340, y: 175 },
  ...
  },
  {
    id: 19,
    name: 'The Compound',
    // 4×3 grid — sniper top-left, knife man mid, sentry bottom-right, 1 can
    // BFS solution: s → d → e(kill km1) → h(kill g2) → k → ex  (5 moves)
    nodes: [
      { id: 's',  x:  80, y: 300 },
      { id: 'a',  x: 210, y: 175 },
      { id: 'b',  x: 340, y: 175 },
  ...
  },
  {
    id: 20,
    name: 'The Penthouse',
    // 4×3 grid — all enemy types, 2 cans
    // BFS solution: s → wait → d(kill km1) → e(kill g2) → wait → h → k(kill st1) → ex  (7 moves)
    nodes: [
      { id: 's',  x:  80, y: 300 },
      { id: 'a',  x: 210, y: 175 },
      { id: 'b',  x: 340, y: 175 },
